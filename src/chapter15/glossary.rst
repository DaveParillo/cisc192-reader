...
.. glossary::
   ...
   map
      A collection of key-value pairs with unique keys. ``std::map`` keeps
      pairs sorted by key.

   iterator
      An object used to refer to and traverse container elements. The
      past-the-end iterator is a sentinel, not an element to dereference.
