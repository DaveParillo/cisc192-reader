...
.. tb-group::
   ...
   .. tb-tab:: Q1
      ...
      .. tb-choice::
         ...
         - [x] ``vector<double> temps (24, 32.00);``
      ...
      .. tb-choice::
         ...
         - [x] Use ``pop_back`` 4 times with no arguments to get rid of the last 4 elements, then use ``push_back`` 3 times
           with arguments to specify which values you want to add to the end.
