...
.. tb-group::
   ...
   .. tb-tab:: Q1
      ...
      .. tb-blank::
         ...
         Another word for an error is a(n) {{blank:blank1}}.  The process of finding 
   ...
   .. tb-tab:: Q2
      ...
      .. tb-match::
         ...
         syntax (compile-time) error
            an error that surfaces when something is wrong with the structure of your program
         run-time error
            an error that comes up when your program is executed
         semantic error
            your program does what you told it to do, not what you intended for it to do
