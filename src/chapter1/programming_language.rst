...
.. tb-group::
   ...
   .. tb-tab:: Q1
      ...
      .. tb-blank::
         ...
         A(n) {{blank:blank1}} translates a high-level program line by line, executing 
         commands as they come.  A(n) {{blank:blank2}} translates a high-level program 
   ...
   .. tb-tab:: Q2
      ...
      .. tb-choice::
         ...
         - [x] Programs written in a high-level language must be translated before they can be run.
   ...
   .. tb-tab:: Q3
      ...
      .. tb-choice::
         ...
         - [x] To copy the program from disk to memory and make the computer run the program.
   ...
   .. tb-tab:: Q4
      ...
      .. tb-match::
         ...
         source code
            our program written in C++
         object code
            translated version of our program that the computer can understand and execute
