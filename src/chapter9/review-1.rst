...
.. tb-group::
   ...
   .. tb-tab:: Q1
      ...
      .. tb-choice::
         ...
         ich of the following are variables of type ``Book``?
   ...
   .. tb-tab:: Q2
      ...
      .. tb-choice::
         ...
         ich of the following are instance variables of type ``Book``?
         ...
         - [x] ``gatsby`` is a ``Book``, not an instance variable of ``Book``. 
         ...
         - [x] ``year`` is an ``int`` declared in ``main``, not an instance variable of ``Book``. 
   ...
   .. tb-tab:: Q3
      ...
      .. tb-choice::
         ...
         - [x] Take a closer look at ``main``. Was the price of the book modified? 
   ...
   .. tb-tab:: Q4
      ...
      .. tb-choice::
         ...
         at kind of function is ``printBook``?
   ...
   .. tb-tab:: Q5
      ...
      .. tb-choice::
         ...
         at is wrong with the code below?
         ...
         - [x] We are allowed to do this. It's usually a good idea to pass structures by reference since it won't make copies of the structures, thus saving memory space.
   ...
   .. tb-tab:: Q6
      ...
      .. tb-choice::
         ...
         at kind of function is ``applyDiscount``?
         ...
         - [x] Does ``applyDiscount`` modify the ``Book`` object?
   ...
   .. tb-tab:: Q7
      ...
      .. tb-choice::
         ...
         - [x] Look at the function declaration of ``midpoint`` carefully.
   ...
   .. tb-tab:: Q8
      ...
      .. tb-choice::
         ...
         at kind of function is ``midpoint``?
         ...
         - [x] Does ``midpoint`` modify a ``Point3D`` object?
   ...
   .. tb-tab:: Q9
      ...
      .. tb-choice::
         ...
         - [x] Take a closer look at the implementation of ``reflectXYPlane``.
