...
.. tb-group::
   ...
   .. tb-tab:: Q1
      ...
      .. tb-match::
         :name: chapter_two_glossary_1

         variable
            A named storage location.
         value
            A letter, or number, or other thing that can be stored.
         type
            A set of values.
         keyword
            A reserved word that is used by the compiler to parse programs.
   ...
   .. tb-tab:: Q3
      ...
      .. tb-match::
         :name: chapter_two_glossary_3

         operator
            A special symbol that represents a simple computation.
         operand
            One of the values that is operated on.
         precedence
            The order in which operations are evaluated.
         composition
            To combine simple expressions and statements into compound statements and expressions.
