...
.. tb-group::
   ...
   .. tb-tab:: Q1
      ...
      .. tb-choice::
         :name: VARS_mc1
          ...
          a look at the following program.  How many lines of output will be produced?
         ...
         - [x] There *are* 5 lines of ``cout`` statments, but that doesn't mean there are 5 lines of output!
   ...
   .. tb-tab:: Q3
      ...
      .. tb-choice::
         ...
         - [x] ``13 - 5`` is computed first because it is in parentheses.
   ...
   .. tb-tab:: Q4
      ...
      .. tb-choice::
         :name: VARS_mc4
          ...
          is printed when the following code is run?
         ...
         - [x] This would be correct if we had written ``cout << x + z``.
   ...
   .. tb-tab:: Q5
      ...
      .. tb-choice::
         ...
         ultiple Response** What could be changed so that the output of the following program is ``34``?
         ...
         int main() {
          ...
          - [x] This will still result in an error.
          ...
          - [x] Although the code will still run, it won't give correct output.
   ...
   .. tb-tab:: Q6
      ...
      .. tb-choice::
         ...
         t is the output of the following code block?
         ...
         int main() {
          ...
          - [x] ``pineapple`` is the name of the variable, but it's not necessarily
   ...
   .. tb-tab:: Q7
      ...
      .. tb-choice::
         ...
         t line does the first error occur in the following program? If there is no error, what is the output?
         ...
         int main() {
          ...
          - [x] A variable can have any value... as long as the types are the same.
   ...
   .. tb-tab:: Q8
      ...
      .. tb-choice::
         ...
         r math teacher just gave an exam that had all of the students panicking.  Four students decide to share their scores to see who did the best.  At the end of the program's execution, who has the highest score on the exam?
         ...
         int main() {
          ...
          - [x] Using the order of operations we have Gretchen scoring 48 / 100.
   ...
   .. tb-tab:: Q9
      ...
      .. tb-choice::
         ...
         int main() {
          ...
          - [x] ``'r'`` isn't necessarily the value of ``r``.  Take a look at line 4.
   ...
   .. tb-tab:: Q10
      ...
      .. tb-choice::
         ...
         you run the following code.  What is the value of ``mod``?
   ...
   .. tb-tab:: Q11
      ...
      .. tb-choice::
         ...
         pose you want to find the volume of a cone.
          reference, the formula is :math:`V = \frac{1}{3}\pi \cdot r^2 \cdot h`.
          the sake of this question, we will use :math:`\pi = 3.14`.
         t is wrong with the following code?
