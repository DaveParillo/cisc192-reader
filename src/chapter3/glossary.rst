...
definition:
    A declaration that also creates a usable entity.
    For example, a function with a function body that can be called.
...
.. tb-group::
   ...
   .. tb-tab:: Q1
      ...
      .. tb-match::
         :name: chapter_three_glossary_one
   ...
   .. tb-tab:: Q2
      ...
      .. tb-match::
         :name: chapter_three_glossary_two
