...
.. tb-group::
   ...
   .. tb-tab:: Q1
      ...
      .. tb-choice::
         ...
         ich of the following are compound values?
   ...
   .. tb-tab:: Q2
      ...
      .. tb-choice::
         ...
         at is wrong with the following ``struct`` definition?
         ...
         - [x] "struct" shouldn't be capitalized in a ``struct`` definition.
   ...
   .. tb-tab:: Q3
      ...
      .. tb-choice::
         ...
         w do we assign the value of 4 to the instance variable ``num_legs`` of the ``dog`` object?
         ...
         - [x] We assign values to the instance variables of a ``struct`` using dot notation. 
   ...
   .. tb-tab:: Q4
      ...
      .. tb-choice::
         ...
         - [x] Take a closer look at the output statements. 
   ...
   .. tb-tab:: Q6
      ...
      .. tb-choice::
         ...
         at is the value of ``s.coffee_cup_full`` when the code is done running?
         ...
         - [x] Take a closer look at the function definition of ``pour_coffee``. 
   ...
   .. tb-tab:: Q7
      ...
      .. tb-choice::
         ...
         at is the value of ``r.batteryLevelPercentage`` when the code is done running?
   ...
   .. tb-tab:: Q8
      ...
      .. tb-choice::
         ...
         - [x] Take a closer look at ``func`` and its parameters. Are they passed by value, passed by reference, or both?
   ...
   .. tb-tab:: Q9
      ...
      .. tb-choice::
         :name: mce_8_9
          ...
          the user inputted the string "R2-D2", what is the output of the code below?
         ...
         - [x] ``name`` is not in quotes so the value stored in ``name`` will be printed.
   ...
   .. tb-tab:: Q10
      ...
      .. tb-choice::
         :name: mce_8_10
          ...
          the user inputted the string "C-3PO", what is the output of the code below?
         ...
         - [x] ``cin`` reads the first ``char`` in from user input.
