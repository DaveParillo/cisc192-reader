...
.. tb-group::
   ...
   .. tb-tab:: Q1
      ...
      .. tb-choice::
         ...
         - [x] When ``i`` is 1, ``x`` is assigned the value of ``i``, so ``x`` is 1. However, the while loop continuously increments i, so the final value of ``x`` is not 1. 
   ...
   .. tb-tab:: Q2
      ...
      .. tb-choice::
         ...
         at is the final value of ``i`` when the code is finished running?
         ...
         - [x] This is the final value of ``x`` when the code is finished running.
   ...
   .. tb-tab:: Q3
      ...
      .. tb-choice::
         ...
         w many times does the following while loop run?
         ...
         - [x] Take a closer look at the while loop and conditional.
   ...
   .. tb-tab:: Q5
      ...
      .. tb-choice::
         ...
         - [x] Take a closer look at the while loop.
   ...
   .. tb-tab:: Q6
      ...
      .. tb-choice::
         ...
         - [x] Take a closer look at the while loop and what ``x`` was initialized to.
   ...
   .. tb-tab:: Q7
      ...
      .. tb-choice::
         ...
         y are we allowed to use the variable ``x`` in both ``main`` and in the function definition of ``superSecretFunction``?
         ...
         - [x] We are actually using two different variables that happen to have the same name.
   ...
   .. tb-tab:: Q9
      ...
      .. tb-choice::
         ...
         e super evil villian RePete wants to annoy the city by
         cking into the city's helper robots and making them repeat
         erything they say 5 times. However, there's an error in his 
         de and now the robots won't stop repeating! Can you find the
         ror?
         ...
         - [x] The initialization of ``n`` occurs outside the ``while`` loop, so the value of ``n`` does not get reset to 0.
   ...
   .. tb-tab:: Q10
      ...
      .. tb-choice::
         ...
         fter making some changes to his code, RePete tries again.
         his time, however, the robots don't repeat anything!
         an you find the new error?
