...
.. tb-group::
   ...
   .. tb-tab:: Q1
      ...
      .. tb-choice::
         ...
         at should be the return type of the function ``convertToCelsius``?
         ...
         - [x] What variable are we returning in the function, and what is the variable's type? 
   ...
   .. tb-tab:: Q2
      ...
      .. tb-choice::
         ...
         at would be returned by ``secretFunction`` if the input was 14?
         ...
         - [x] Take a closer look at the conditional statements. 
   ...
   .. tb-tab:: Q3
      ...
      .. tb-choice::
         :name: mce_5_3
          ...
          we wanted to create a boolean function called ``isPrime``, which takes an ``int input``
          a parameter, which of the following would be the correct function header?
         ...
         - [x] In a function header, the type of each variable must be specified in the parameter list.
   ...
   .. tb-tab:: Q4
      ...
      .. tb-choice::
         :name: mce_5_4
          ...
          we wrote the following function, which of the other functions below can we also legally write
         ...
         - [x] Since this function has the same name and parameter types as the given function, it is not allowed.
         ...
         - [x] Although this function has a different return type, its parameter list is the same as the given function, so it is not allowed.
   ...
   .. tb-tab:: Q7
      ...
      .. tb-choice::
         ...
         e there any issues with the code below?
         ...
         - [x] The type of variables in the parameter list do not affect the return type.
   ...
   .. tb-tab:: Q8
      ...
      .. tb-choice::
         ...
         - [x] Implicit conversion from an int to double is ok in c++!
   ...
   .. tb-tab:: Q9
      ...
      .. tb-choice::
         ...
         - [x] We are allowed to use ``cout`` statements in a function.
   ...
   .. tb-tab:: Q10
      ...
      .. tb-choice::
         ...
         - [x] What keyword do we use before ``main()`` in every program?
   ...
   .. tb-tab:: Q11
      ...
      .. tb-choice::
         ...
         at is the base case of the ``factorial`` recursive function?
   ...
   .. tb-tab:: Q12
      ...
      .. tb-choice::
         ...
         - [x] The base case prints something!
